    ...
    <div className="col-span-12 grid grid-cols-12 gap-x-5 border-[#999999] border-dashed border-t border-1 text-xs-medium mb-[200px]">
      {project._id != prevProject._id ?
        <div className="col-span-3 flex flex-col mt-[10px]">
          ...
          <img className="w-full mb-5" src={prevProject.hero_display == "Landscape" ? prevProject.landscape_hero.imageUrl : prevProject.portrait_hero.imageUrl} alt=""/>
          <a href={`/project/${prevProject._id}`} className="w-fit bg-[#F5F5F5] rounded-[5px] flex text-xs p-3 cursor-pointer hover:opacity-50">
            View Project
      ...
      {project._id != prevProject._id ?
        <div className="col-span-3 col-start-10 flex flex-col mt-[10px]">
          ...
          <img className="w-full mb-5" src={nextProject.hero_display == "Landscape" ? nextProject.landscape_hero.imageUrl : nextProject.portrait_hero.imageUrl} alt=""/>
          <a href={`/project/${prevProject._id}`} className="w-fit bg-[#F5F5F5] rounded-[5px] flex text-xs p-3 cursor-pointer hover:opacity-50">
            View Project
            <div className="ml-[50px] flex items-center">
              <svg width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
