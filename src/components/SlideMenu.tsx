...
export default function SlideMenu() {
	...
	return (
		<section className="w-full h-screen fixed top-0 left-0 grid grid-cols-2 z-20 transform translate-x-full transition duration-300" id="menu">
			<button className="flex fixed top-2 right-5 text-xxs bg-white bg-opacity-20 backdrop-blur-3xl p-3 rounded-[5px] z-10 text-white transition duration-300 hover:bg-opacity-50" id={"closeMenuButton"}>
			...
			<div className="bg-black flex flex-col">
				<div className="text-white text-lg flex flex-col m-5 h-fit relative z-1">
					...
					<a href="/selected-projects" className="hover:opacity-50 transition duration-250 w-fit">
						Selected Projects
					</a>
					<a href="" className="hover:opacity-50 transition duration-250 w-fit">
						Showhomes
				...
				<div className="mt-auto w-full flex justify-between text-xxs text-white m-5">
					<div className="flex flex-col">
						<a href="tel:033438260" className="hover:opacity-50 transition duration-250 w-fit">
							03 343 8260
						</a>
						<a href="mailto:info@benchmarkhomes.co.nz" className="hover:opacity-50 transition duration-250 w-fit">
