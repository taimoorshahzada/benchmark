...
export default function Footer() {
  return (
    <footer className="bg-white bg-opacity-20 backdrop-blur-xl h-screen relative z-10" id="footer">
      <div className="absolute bottom-0 grid grid-cols-12 gap-x-5 text-xs-medium mx-auto w-full bg-white p-5">
        <div>
          <svg width="80" height="20" viewBox="0 0 80 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fillRule="evenodd" clipRule="evenodd" d="M20 0L0 20V0H20ZM20 0L40 20H80L60 0H20Z" fill="black"/>
          </svg>
        ...
        <div className="col-start-10 col-span-3 text-xxs">
          Copyright © 2023 Benchmark Homes | All Rights Reserved. View Privacy Policy & Email Disclaimer.
        </div>
      </div>
    </footer>
  );
