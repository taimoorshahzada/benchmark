...
export default function ProjectInfo({projects, id}: any) {
 ...
 return (
  <div className="col-span-12 grid grid-cols-12 gap-x-5">
    ...
    <div className="col-span-12 text-lg mb-[200px] px-5">
      <div className="mb-10">
        {project.title}
      </div>
      <div>
