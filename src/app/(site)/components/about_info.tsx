...
export default function AboutInfo({ info }: any) {

  console.log(info)

  useEffect(() => {
    const expandAccordion = (accordion: Element) => {
      accordion.classList.toggle("expanded")
      accordion.nextElementSibling?.classList.toggle("expanded")
    }

    document.querySelectorAll(".accordion").forEach((accordion) => {
      if (accordion.getAttribute("event-listener") != "true") {
        accordion.addEventListener("click", () => expandAccordion(accordion))
        accordion.setAttribute("event-listener", "true")
      }
    })
  }, []);
  ...
  return (
    <div className="flex">
      ...
      <div className="w-1/2 h-fit">
        <h1 className="font-medium text-lg lg:text-xl xl:text-2xl col-span-11 mb-medium mx-5">
          About Us
        </h1>
        <div className="text-base mb-[450px] mx-5">
          {info.description}
        </div>
        <div className="text-xs-medium mb-7 mx-5">
          Over the Years
        </div>
        ...
        <div className="text-xs flex justify-between mb-large mx-5">
          ...
          <div>
            Want to learn more about us? Check out our magazine
								<a target="_blank" href=""> here <span><svg width="6" height="12" viewBox="0 0 6 12" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="border-grey border-dashed border-t border-1 pt-[10px] mb-[100px] mx-5">
          <div className="text-xs-medium mb-10">
            Years of Experience
          </div>
        ...
        <div className="p-5 bg-black text-white flex flex-col text-xs pb-[200px]">
          ...
          <div className="ml-[33%] mr-5 flex flex-wrap gap-x-5 gap-y-[47px]">
            <div className="w-1/2 flex flex-col">
              <Image className="w-full h-auto mb-5" src={Photo} alt="Richard and Sam" width={500} height={500} />
              <div className="text-xs-medium">
                Richard Evans
              </div>
              <div className="text-xs-medium">
                Director
