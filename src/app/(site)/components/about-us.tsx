  ...
  return (
		<section className="col-span-12">
			...
			<div className="grid grid-cols-2 min-h-screen relative">
				<div className="pinned border-y md:border-b border-dotted border-grey pt-3 pb-32 md:pb-24 mx-5 col-span-2 md:row-start-1 md:col-span-1 mt-12 md:mt-[300px] h-screen">
				...
				<div className="border-y border-dotted border-grey pt-3 pb-32 md:pb-24 mx-5 col-span-2 md:col-span-1 md:row-start-2 h-screen">
					<h4 className="md:pt-3 text-xs-medium pb-8 md:pb-0">
				...
				<div className="border-y border-dotted border-grey pt-3 pb-32 md:pb-24 mx-5 col-span-2 md:col-span-1 md:row-start-3 h-screen">
				...
				<div className="mx-5 col-span-2 md:col-span-1 mb-[300px] md:row-start-4 ">
