  ...
  return (
    <section className="col-span-12">
      ...
      <div className="grid grid-cols-2 min-h-screen relative">
        <div className="pinned border-y md:border-b border-dotted border-grey pt-3 pb-32 md:pb-24 mx-5 col-span-2 md:row-start-1 md:col-span-1 mt-12 md:mt-[300px] md:h-screen">
