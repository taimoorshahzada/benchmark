...
export default function Home() {
  return (
    <>
      <Container>
        <h1 className="font-medium text-sm-3xl md:text-3xl col-span-11 -translate-x-5 mb-large mt-24 md:mt-3">
          <Image
            className="pl-5"
            src={Benchmark}
            alt="Benchmark Homes"
        ...
        <p className="font-medium text-sm-lg md:text-lg col-span-12 my-medium">
